    ...
    imgloop(ar) {
      ...
      else if(this.checkImageExistance(ar) > 0 && this.checkImageExistance(ar) < ar.length)
      {
        ...
        for (let i = 0; i < ar.length; i++) {
            ...
            img.alt = "Camera Trap";
            img.datamarked = 0;
            ul.innerHTML += '<li  ><img id="' + liId + '" data-original="' + img.src + '"  marked="' + img.datamarked + '" data-original="' + img.src + '"onerror="'+ "this.onerror=null;this.src='/srv/shiny-server/www/PantheraIDS_image_not_found_2.jpg'" +'"  alt="' + img.alt + '" /> </li>';
