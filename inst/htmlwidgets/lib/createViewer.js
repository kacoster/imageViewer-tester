    ...
    selected_images = [];
    tempRemove = "";
    result = [] ; window.start = 0;
    batnum = 0; // default batch Number
    imgNumb = 5; // default image size
  ...
  class ModuleViewer
  {
       ...
       loadDoc(url,cFunction)
        ...
        readServerData(msg)
        {
            ...
            this.loadDoc(csvfile,this.myFunction1);
        }
      ...
      setImgNumb(imgNumb)
      {
        ...
        myFunction1(xhttp)
        {
            ...
            console.log("Image Number in myFunction1 : " + window.imgNumb);
            //initial(this.imgNumb,0);
        ...
        Shiny.addCustomMessageHandler("btch_img_num",
            function(message) {
            //console.log() "btch_img_msg",

            imgNumb =  parseInt(JSON.stringify(message));
            console.log("myFunction Reactive imgNumb : " +  imgNumb);
        ...
        prev()
        {
          ...
          if (this.batnum > 0 )
          {
            this.initial(this.imgNumb ,this.batnum);
          }else
          {
